...
class MousePositionPredictor(nn.Module):
    def __init__(self):
        ...
        self.conv1 = nn.Conv2d(3, 32, kernel_size=7, stride=3, padding=3)
        self.conv2 = nn.Conv2d(3, 32, kernel_size=5, stride=3, padding=2)
        self.relu = nn.ReLU(inplace=True)

        # Calculate the output dimensions of conv1 and conv2
        out_dim1 = 32 * 360 * 240
        out_dim2 = 32 * 360 * 240

        self.fc1 = nn.Linear(out_dim1 + out_dim2, 128)
